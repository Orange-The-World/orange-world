...
const RESEND_FROM = Deno.env.get("RESEND_FROM") || "Orange the World <hello@orangethe.world>";
const WORLD_BASE_URL = Deno.env.get("WORLD_BASE_URL") || "https://orangethe.world";
