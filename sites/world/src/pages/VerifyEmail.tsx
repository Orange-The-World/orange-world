...
const API_BASE = import.meta.env.VITE_OW_SUPABASE_URL as string;
const ANON_KEY = import.meta.env.VITE_OW_SUPABASE_ANON_KEY as string;
...
export default function VerifyEmail() {
  ...
  "${API_BASE}/functions/v1/world-gateway/bitcoin-network?limit=5"`}</pre>
      ...
      <p className="mt-6 text-sm text-slate-500">
        Read the docs and dataset reference at{" "}
        <a href="/docs" className="text-orange underline">
          /docs
        </a>
        .
      </p>
